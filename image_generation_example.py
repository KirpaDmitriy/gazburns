...
def add_text_to_image(image, text):
    ...
    font = ImageFont.load_default()  # Вы можете заменить на другой шрифт при необходимости
    text_position = (50, 50)
...
def generate_banner(cluster, product=None):
    ...
    final_image = combine_images(gradient_background, scaled_image, (1050, 20))  # Позиция может быть скорректирована
